...
├── 404.html (noindex) · robots.txt · sitemap.xml (55 URL) · feed.xml (RSS усього сайту)
├── journal/              ← «Журнал»: index (стрічка всіх 21 поста + фільтр жанрів, посилання на хаби)
├── journal/{slug}/       ← 21 пост: есеї, оповідання, пісні, щоденник, подорожі, рубрика Паркінсон
