...
/** R1 of Ф1: commercial chat CTAs, file → anchor texts (25 in 22 files). Files not listed are unconstrained. */
const CTA_FILES = {
...
export const PHASES = {
  ...
  'f1-pre': {
    ...
    links: [
      { rule: 'cta-links', href: `${SITE}/#chat-section`, files: CTA_FILES },
...
export const CURRENT_PHASE = 'f1-pre';
