...
> Частина `doc/PERSONAL_SITE_PLAN.md` (фаза Ф1). Статус: **кроки 1–3 виконано, не запушено** — крок 1 `a40087c`,
> чесні підписи бота `2e849d1`, крок 2 `727332f`, крок 3 — локально (фаза валідатора `f1-done`); далі пуш і кроки 5–6.
> FAQ `/services/` — на затвердженні власника до пушу.
...
4. `feat(links): repoint homepage anchors to /services/` (скрипт + тести + застосовані зміни + чесні CTA-тексти, v3)
5. `docs: Ф1 статус`
