...
> **Статус (2026-09-18):** 🗄 історичний документ (квітень 2026) — SEO-план сайту послуг розробника. Замінено переробкою в особистий сайт: `doc/PERSONAL_SITE_PLAN.md`. Спринти A–C виконано; незакриті пункти D–F переглядаються в межах переробки. Baseline 2026-09: комерційні запити в топ не вийшли.
